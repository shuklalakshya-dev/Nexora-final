      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold mb-6">
            Meet the <span className="bg-gradient-to-r from-sky-400 to-emerald-400 bg-clip-text text-transparent">Team</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-gray-900/40 backdrop-blur-sm p-6 rounded-2xl gradient-border hover-scale text-center">
            <div className="relative w-32 h-32 mx-auto mb-6 overflow-hidden rounded-full bg-gradient-to-r from-sky-400 to-emerald-400 p-1">
          ...
          <div className="bg-gray-900/40 backdrop-blur-sm p-6 rounded-2xl gradient-border hover-scale text-center">
            ...
            <h3 className="text-xl font-bold">Lakshya Shukla</h3>
